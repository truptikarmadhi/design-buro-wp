...
<?php if (have_rows("flexible_content")):
    while (have_rows("flexible_content")):
                        ...
                        <div class="h-100 position-relative">
                            ...
                            <?php elseif(!empty($media_type) && $media_type == 'youtube' && !empty($youtube)): ?>
                                <iframe class="w-100 h-100 object-cover"
                                    src="https://www.youtube.com/embed/<?php echo $youtube; ?>?playlist=<?php echo $youtube; ?>&autoplay=1&loop=1&background=1&controls=0&rel=0&mute=1&modestbranding=1&showinfo=0&iv_load_policy=3&disablekb=1"
                            ...
                            <?php endif; ?>
                            <div class="position-absolute start-0 bottom-0 tpb-0 dpb-80 w-100 res-h-100 d-flex align-items-center wow animated animate__fadeInUp" data-wow-duration="1.5s">
                                <div class="container">
                                    <div class="col-lg-6 col-12">
                                        <?php if (!empty($title)): ?>
                                            <div class="sans-medium font61 space-0_61 leading61 res-font35 res-leading40 res-space-0_35 text-white dmb-10">
                                                <?php echo $title; ?>
                                            </div>
                                        <?php endif; ?>
            ...
            <section class="masonory-image-section">
                <div class="container">
                    <div class="row row8">
                        ...
                        ?>
                            <?php if(!empty($image)):?>
                                <div class="image-card tmb-10 dmb-20 wow animated animate__fadeInUp" data-wow-duration="1.5s">
        ...
        <?php elseif (get_row_layout() == 'project_card_section'):
        ...
        ?>
            <section class="project-card-section bg-edf4f3">
                <div class="container container2">
                    <div class="row justify-content-between dmb-50 tmb-35 wow animated animate__fadeInUp" data-wow-duration="1.5s">
                        <div class="col-lg-7 col-12">
                            <div class="sans-medium font61 space-0_61 leading61 res-font36 res-space-0_72 text-06556c tmb-15">
                                <?php if (!empty($title)): ?>
                                    <?php echo $title; ?>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="image-card tmb-10 dmb-20 wow animated animate__fadeInUp" data-wow-duration="1.5s">
                                    <div class="position-relative radius10 overflow-hidden h-100">
                                        <a href="<?php echo $link; ?>">
                                            <div class="project-bg-layer position-absolute bottom-0 start-0 w-100 h-100"></div>
                                            <img class="w-100 h-100 object-cover" src="<?php echo $image; ?>"
                                                alt="Project Image">
        ...
        ?>
            <section class="sub-hero-section position-relative">
                ...
                <?php elseif(!empty($hero_media_type) && $hero_media_type == 'vimeo' && !empty($vimeo)): ?>
                    <iframe class="w-100 h-100 object-cover"
                        src="https://player.vimeo.com/video/<?php echo $vimeo; ?>?autoplay=1&loop=1&background=1&controls=0&rel=0&mute=0"
                        allow="autoplay" allowfullscreen>
                    </iframe>
                <?php endif; ?>

                <?php if(!empty($heading)):?>
                     <div class="position-absolute bottom-0 dmb-75 start-0 w-100 wow animated animate__fadeInUp" data-wow-duration="1.5s">
                        <div class="container">
                            <div class="sans-medium font61 space-0_61 leading61 text-white text-capitalize">
                                <?php echo $heading; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between wow animated animate__fadeInUp" data-wow-duration="1.5s">
                        ...
                        <div class="col-lg-5 pe-2">
                            <?php if (!empty($content)): ?>
                                <div class="sans-medium font15 leading24 text-000b18 dmb-20 tmb-0">
                                    <?php echo $content; ?>
                                </div>
                            <?php endif; ?>
                        </div>
        ...
        ?>
            ...
            <section class="team-slider-section bg-edf4f3 <?php echo ($half_curve == 'yes') ? 'half-curve tpt-70 dpt-90' : ''; ?>">
                <div class="container container2">
                    <div class="d-flex align-items-center dmb-30 wow animated animate__fadeInUp" data-wow-duration="1.5s">
                        <?php if (!empty($title)): ?>
                            <div class="col-6 ">
                                <div class="sans-medium font48 leading44 space-0_96 res-font36 res-space-0_72 text-06556c col-lg-6"><?php echo $title; ?></div>
                            </div>
                        <?php endif; ?>
                    ...
                    <?php if ($team_content == 'slider'): ?>
                        <div class="team-slider wow animated animate__fadeInUp" data-wow-duration="1.5s">
                        ...
                        <div class="d-flex justify-content-center tmt-45 wow animated animate__fadeInUp" data-wow-duration="1.5s">
                             <?php if (!empty($link['url']) && !empty($link['title'])): ?>
                    ...
                    <?php elseif ($team_content == 'card'): ?>
                        <div class="row row8 res-row4">
                            ...
                            ?>
                                <?php if (!empty($image)): ?>
                                    <div class="col-md-3 col-6 team-cards tmb-10 dmb-15 wow animated animate__fadeInUp" data-wow-duration="1.5s">
        ...
        ?>
            <section class="left-accordion-section">
                <div class="container container2">
                    <div class="row flex-lg-row flex-column flex-column-reverse justify-content-between wow animated animate__fadeInUp" data-wow-duration="1.5s">
                                    ...
                                    <?php if (!empty($title)): ?>
                                        <div class="closet-item bg-268a85 radius10 dmb-10">
                                            ...
                                            <div class="closet-content ps-4 px-lg-5 dpb-50">
                                                <?php if (!empty($description)): ?>
                                                    <div class="sans-medium font14 leading24 text-white col-10 pe-2">
                                                        <?php echo $description; ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                        ...
                        ?>
                            <div class="col-lg-6">
                                <div class="col-10 ms-lg-auto">
                                    <div class="sans-medium font48 leading44 res-font36 space-0_96 res-space-0_72 text-06556c dmb-15"><?php echo $title; ?></div>
                                    <?php if (!empty($about_content)): ?>
